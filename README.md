...
Первый вертикальный срез реализован: генерируемая тайловая карта, туман войны, постоянные отряды, поселения, экономика, исследования, автономная угроза и локальные сохранения. Это новая модульная реализация, не код закрытого PR и не фиксированный граф регионов.
